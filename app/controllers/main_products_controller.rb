  ...
  def create
    ...
    respond_to do |format|
      if @main_product.save
        format.html { redirect_to main_products_path, notice: 'Main product was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @main_product.update(main_product_params)
        format.html { redirect_to main_products_path, notice: 'Main product was successfully updated.' }
